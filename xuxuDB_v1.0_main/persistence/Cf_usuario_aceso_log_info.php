...
class Cf_usuario_aceso_log_info{

 
/* TABLE FIELD: id_usuario_aceso_log ---------*/
	private $id_usuario_aceso_log_null = FALSE;
	private $id_usuario_aceso_log_type = 'int';
	private $id_usuario_aceso_log_size = '11';
