...
class Cf_usuario_institucion extends ClassTO implements InterfaceTO{

	private $id_usuario_institucion = array();
	private $id_usuario = array();
	private $id_usuario_class = 'Cf_usuarios';
	private $id_usuario_obj = array();
	private $id_institucion = array();

	private $primary_key = 'id_usuario_institucion';
