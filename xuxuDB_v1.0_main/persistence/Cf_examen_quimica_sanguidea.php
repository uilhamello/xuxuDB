...
class Cf_examen_quimica_sanguidea extends ClassTO implements InterfaceTO{

	private $id_quimica_sanguinea = array();
	private $id_examen = array();
	private $id_examen_class = 'Cf_examen';
	private $id_examen_obj = array();
	private $colesterol = array();
	private $trigliceridos = array();
	private $glucosa = array();
	private $acido_lactico = array();

	private $primary_key = 'id_quimica_sanguinea';
