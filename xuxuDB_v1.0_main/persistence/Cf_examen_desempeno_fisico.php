...
class Cf_examen_desempeno_fisico extends ClassTO implements InterfaceTO{

	private $id_desempeno_fisico = array();
	private $id_examen = array();
	private $id_examen_class = 'Cf_examen';
	private $id_examen_obj = array();
	private $equilibrio = array();
	private $velocidad = array();
	private $flexibilidad = array();
	private $fuerza_brazos1 = array();
	private $fuerza_brazos2 = array();
	private $fuerza_brazos3 = array();
	private $fuerza_abdominal = array();
	private $salto_vertical = array();

	private $primary_key = 'id_desempeno_fisico';
