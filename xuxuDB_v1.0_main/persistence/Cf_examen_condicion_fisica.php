...
class Cf_examen_condicion_fisica extends ClassTO implements InterfaceTO{

	private $id_condicion_fisica = array();
	private $id_examen = array();
	private $id_examen_class = 'Cf_examen';
	private $id_examen_obj = array();
	private $course_navette = array();
	private $saturacion_actividad = array();
	private $pulso_actividad = array();

	private $primary_key = 'id_condicion_fisica';
