...
class Cf_usuario_acesso_log extends ClassTO implements InterfaceTO{

	private $id_usuario_acesso_log = array();
	private $id_usuario = array();
	private $id_usuario_class = 'Cf_usuarios';
	private $id_usuario_obj = array();
	private $inicio = array();
	private $aceso_ativo = array();
	private $fin = array();

	private $primary_key = 'id_usuario_acesso_log';
