...
class Cf_examen_signos_vitales extends ClassTO implements InterfaceTO{

	private $id_signos_vitales = array();
	private $id_examen = array();
	private $id_examen_class = 'Cf_examen';
	private $id_examen_obj = array();
	private $saturacion = array();
	private $pulso = array();
	private $sistolica = array();
	private $diastolica = array();

	private $primary_key = 'id_signos_vitales';
