...
class Cf_examen_estado_nutricio extends ClassTO implements InterfaceTO{

	private $id_estado_nutricio = array();
	private $id_examen = array();
	private $id_examen_class = 'Cf_examen';
	private $id_examen_obj = array();
	private $estatura = array();
	private $estatura_sentado = array();
	private $peso = array();
	private $peso_flexion = array();
	private $porcentaje_grasa = array();
	private $cintura = array();
	private $longitud_brazo = array();

	private $primary_key = 'id_estado_nutricio';
